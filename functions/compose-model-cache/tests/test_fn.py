        ...
        "spec": {
            "forProvider": {
                "manifest": {
                    ...
                    "metadata": {"name": _PVC_NAME, "namespace": "mp-ml-team", "labels": _LABELS},
                    "spec": {
        ...
        "spec": {
            "forProvider": {
                "manifest": {
                    "apiVersion": "batch/v1",
                    "kind": "Job",
                    "metadata": {"name": _JOB_NAME, "namespace": "mp-ml-team", "labels": _LABELS},
                    "spec": {
                        "backoffLimit": 3,
        ...
        "spec": {
            "forProvider": {
                "manifest": {
                    "apiVersion": "v1",
                    "kind": "Secret",
                    "metadata": {"name": _AUTH_NAME, "namespace": "mp-ml-team", "labels": _LABELS},
